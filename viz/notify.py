...
from vizapi.websocket import ClientWebsocket
...
class Notify(Events, BlockchainInstance):
    ...
    :param list markets: Instances of :class:`viz.market.Market` that identify markets to be monitored
    ...
    **Example**
    ...
    .. code-block:: python
        ...
        from viz.notify import Notify
        from viz.market import Market
    ...
    def process_market(self, data):
        ...
        * :class:`viz.price.Order` or
        * :class:`viz.price.FilledOrder` or
        * :class:`viz.price.UpdateCallOrder`
    ...
    def process_account(self, message):
        ...
        It will return instances of :class:viz.account.AccountUpdate`
        """
