...
API = {
    ...
    # prediction_market_api (HF14) — read-only market/oracle/liquidity/dispute/leverage queries.
    # Generated from `grep -r DEFINE_API_ARGS plugins/prediction_market_api`.
